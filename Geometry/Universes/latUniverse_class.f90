module latUniverse_class
  ...
  ! Parametrs
  ! Note X/Y/Z MIN/MAX MUST hate the value they have (or generated by a function)
  ...
  !!
  !! Universe consits of a lattice of fixed, finate size (e.g 17x17x2). Centre of the
  !! latticle is placed at the origin. An additional cell is placed beyond the lattice
  ...
  !!   latt2D { id 8;
  !!            shape (2 2 0);       // 0 indicates infinate extent in z-axis
